...
export constant xSDL_Swap16 = define_c_func(sdl,"+SDL_Swap16",{C_UINT},C_UINT)

public function SDL_Swap16(atom x)
	return c_func(xSDL_Swap16,{x})
end function

export constant xSDL_Swap32 = define_c_func(sdl,"+SDL_Swap32",{C_UINT},C_UINT)

public function SDL_Swap32(atom x)
	return c_func(xSDL_Swap32,{x})
end function

export constant xSDL_Swap64 = define_c_func(sdl,"+SDL_Swap64",{C_UINT},C_UINT)

public function SDL_Swap64(atom x)
	return c_func(xSDL_Swap64,{x})
end function

export constant xSDL_SwapBE16 = define_c_func(sdl,"+SDL_SwapBE16",{C_UINT},C_UINT)

public function SDL_SwapBE16(atom x)
	return c_func(xSDL_SwapBE16,{x})
end function

export constant xSDL_SwapBE32 = define_c_func(sdl,"+SDL_SwapBE32",{C_UINT},C_UINT)

public function SDL_SwapBE32(atom x)
	return c_func(xSDL_SwapBE32,{x})
end function

export constant xSDL_SwapBE64 = define_c_func(sdl,"+SDL_SwapBE64",{C_UINT},C_UINT)
...
export constant xSDL_SwapLE16 = define_c_func(sdl,"+SDL_SwapLE16",{C_UINT},C_UINT)

public function SDL_SwapLE16(atom x)
	return c_func(xSDL_SwapLE16,{x})
end function

export constant xSDL_SwapLE32 = define_c_func(sdl,"+SDL_SwapLE32",{C_UINT},C_UINT)

public function SDL_SwapLE32(atom x)
	return c_func(xSDL_SwapLE32,{x})
end function

export constant xSDL_SwapLE64 = define_c_func(sdl,"+SDL_SwapLE64",{C_UINT},C_UINT)
