...
public constant SDLK_CAPSLOCK = SDL_SCANCODE_CAPSLOCK,
    ...
    SDLK_KP_EQUALSAS400 = SDL_SCANCODE_KP_EQUALSAS400,
    ...
    SDLK_THOUSANDSSEPARATOR = SDL_SCANCODE_THOUSANDSSEPARATOR,
    SDLK_DECIMALSEPARATOR = SDL_SCANCODE_DECIMALSEPARATOR,
    SDLK_CURRENCYUNIT =SDL_SCANCODE_CURRENCYUNIT,
    ...
    SDLK_KP_MEMDIVIDE = SDL_SCANCODE_KP_MEMDIVIDE,
    ...
    SDLK_AC_BACK = SDL_SCANCODE_AC_BACK,
    ...
    SDLK_APP1 = SDL_SCANCODE_APP1,
    SDLK_APP2 = SDL_SCANCODE_APP2,

    SDLK_AUDIOREWIND = SDL_SCANCODE_AUDIOREWIND,
    SDLK_AUDIOFASTFORWARD = SDL_SCANCODE_AUDIOFASTFORWARD,

    SDLK_SOFTLEFT = SDL_SCANCODE_SOFTLEFT,
    SDLK_SOFTRIGHT = SDL_SCANCODE_SOFTRIGHT,
    SDLK_CALL = SDL_SCANCODE_CALL,
    SDLK_ENDCALL = SDL_SCANCODE_ENDCALL
...
public constant KMOD_SHIFT = or_all({KMOD_LSHIFT,KMOD_RSHIFT})
public constant KMOD_ALT = or_all({KMOD_LALT,KMOD_RALT})
public constant KMOD_GUI = or_all({KMOD_LGUI,KMOD_RGUI})

public constant KMOD_RESERVED = KMOD_SCROLL
­294.43