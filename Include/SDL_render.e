...
--added by CMB
public constant SDL_Texture = define_c_type({
    C_POINTER,          --const void *magic;
    C_UINT32,           --Uint32 format;              
    C_INT,              --int access;                 
    C_INT,              --int w;                      
    C_INT,              --int h;                      
    C_INT,              --int modMode;                
    C_INT,              --SDL_BlendMode blendMode;    
    {C_UINT8, 4},       --Uint8 r, g, b, a;           
    C_POINTER,          --SDL_Renderer *renderer;

    /* Support for formats not supported directly by the renderer */
    C_POINTER,          --SDL_Texture *native;
    C_POINTER,          --SDL_SW_YUVTexture *yuv;
    C_POINTER,          --void *pixels;
    C_INT,              --int pitch;
    C_POINTER,          --SDL_Rect locked_rect;                     --hmm - not marked as a pointer

    C_POINTER,          --void *driverdata;           
    C_POINTER,          --SDL_Texture *prev;
    C_POINTER           --SDL_Texture *next;
})
